...
// Helper to get flag emoji from ISO2
...
// We put Colombia (CO) at the top, followed by United States (US) and Spain (ES),
// and then the rest of the countries sorted alphabetically by nameES.
export const sortedCountries: Country[] = [...rawCountries]
  ...
  .sort((a, b) => {
    ...
    // Sort the rest alphabetically by Spanish name
