...
export default function CardTicketIndividual({ ticket, remainingStock, onClose }: CardTicketIndividualProps) {
  ...
  // Subcomponente compartido — contenido interior
  const CardContent = () => (
    <>
      {/* Title & Icon */}
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-4 z-50 w-8 h-8 rounded-full bg-[#E8E2DA] flex items-center justify-center text-[#231E1A] hover:bg-[#D8D0C5] transition-colors text-sm font-semibold shadow-md cursor-pointer"
          aria-label="Cerrar"
        >
          ✕
        </button>
