...
// ==========================================
// Hora programada: 25 de Junio de 2026, 10:05 AM (Hora Colombia: UTC-5)
const TARGET_DATE_STRING = '2026-06-25T10:05:00-05:00';
  ...
  try {
    ...
    if (!isPastTargetTime && !force) {
      ...
      return NextResponse.json({
        success: false,
        message: `Aún no es la hora programada. Faltan ${secondsLeft} segundos para el envío (10:05 AM Colombia).`,
