...
export default function PolicyPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#EAE0CE] font-sans pb-10">
      <Marquee />
      <Navbar />
      ...
      <div className="flex-1 flex flex-col items-center justify-center pt-16 px-4 md:px-8 pb-16 w-full">
        <div className="w-full max-w-2xl  rounded-2xl p-6 md:p-10">
          <h1 className="font-nunito uppercase text-3xl md:text-4xl text-[#231E1A] text-center leading-tight mb-2">
            {t.policy.title}
          </h1>

          <div className="h-px bg-[#EAE0CE] my-4" />

          <ol className="flex flex-col gap-2.5">
            {t.policy.items.map((policy, i) => (
              <li key={i} className="flex gap-2 items-start">
                <span className="font-nunito text-[16px] font-bold text-[#231E1A] flex-shrink-0 bg-[#EAE0CE] w-8 h-8 rounded-full flex items-center justify-center">
                  {i + 1}.
                </span>
